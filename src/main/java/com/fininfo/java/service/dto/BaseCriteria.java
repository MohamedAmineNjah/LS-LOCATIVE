...
/**
 * Criteria class for the {@link com.fininfo.java.domain.Base} entity. This class is used
 * in {@link com.fininfo.java.web.rest.BaseResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /bases?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
