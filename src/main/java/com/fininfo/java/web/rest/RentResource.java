...
/**
 * REST controller for managing {@link com.fininfo.java.domain.Rent}.
 */
@RestController
@RequestMapping("/api")
public class RentResource {
    ...
    private static final String ENTITY_NAME = "locativeRent";
    ...
    public ResponseEntity<RentDTO> updateRent(@RequestBody RentDTO rentDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, rentDTO.getId().toString()))
            .body(result);
    }
